# StartJobGroup {#doc_api_cityvisual_StartJobGroup .reference}

调用StartJobGroup启动指定的计算工作组。

## 调试 {#api_explorer .section}

[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/#product=cityvisual&api=StartJobGroup&type=RPC&version=2018-10-30)

## 请求参数 {#parameters .section}

|名称|类型|是否必选|示例值|描述|
|--|--|----|---|--|
|Action|String|是|StartJobGroup|系统规定参数。取值：**StartJobGroup**。
...
http(s)://[Endpoint]/?Action=StartJobGroup
&<公共请求参数>
